...
[수혜 대상 연령 판단]
나눔카트는 보육원·아동센터 등 아동·청소년(0~18세)을 위한 후원 플랫폼이야.
...
"나눔카트는 보육원·아동센터 등 아동·청소년 시설 후원 플랫폼이에요. 0~18세 아이들을 위한 물품만 취급하고 있어요."
...
router.post('/org-recommend', async (req: Request, res: Response) => {
  ...
  const systemPrompt = `
너는 아동·청소년 후원 플랫폼 나눔카트에서, 기관에게 "다음에 어떤 물품을 요청하면 좋을지" 추천하는 AI 도우미야.
