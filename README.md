...
1. main 브랜치 최신화
새로운 작업을 시작하기 전 siempre main 브랜치를 최신 상태로 업데이트합니다.
...
깃허브 저장소 페이지(https://github.com/MS0526/likey-web)에 접속합니다.

상단에 뜨는 Compare & pull request 버튼을 클릭합니다.

작업 내용 요약을 적고 Create pull request를 클릭해 팀장에게 검토 요청을 보냅니다.
...
### 📤 완성한 README.md 깃허브에 반영하기

VS Code에서 `README.md` 파일을 저장하신 후, 터미널에 아래 3줄을 치면 깃허브 저장소 메인 화면에 예쁘게 반영됩니다!

```bash
git add README.md
git commit -m "docs: Update team onboarding and collaboration README"
