...
설치가 끝났다면 아래 명령어를 실행하여 웹 화면을 켭니다.
...
- `git commit -m "..."`: "어떤 작업을 했는지" 설명표표를 붙여 내 컴퓨터에 저장합니다.
...
2. 화면 상단에 녹색으로 뜨는 **`Compare & pull request`** 버튼을 클릭합니다.
